...
class _SessionContext:
    ...
    Explicitly commits transactions on successful exit and rolls back on exceptions.
    Use session.flush() to persist changes within the transaction for ID generation,
    then the context manager will commit on exit.
    """
